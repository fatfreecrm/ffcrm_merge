...
describe AccountAlias do
  ...
  describe "ids_with_alias" do
    ...
    before(:each) do
      ...
      FactoryBot.create(:account_alias, destroyed_account_id: 21, account_id: @account1.id)
    end
    ...
    it "should replace a list of alias ids with the correct id" do
      ...
      expect(AccountAlias.ids_with_alias(ids)).to eql( {"21" => id1} )
    end
    ...
    it "should handle multiple merges" do
      FactoryBot.create(:account_alias, destroyed_account_id: 22, account_id: @account1.id)
      ids = ['21', '22']
      id1 = @account1.id.to_s
