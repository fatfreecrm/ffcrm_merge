...
describe ContactAlias do
  ...
  describe "ids_with_alias" do
    ...
    before(:each) do
      ...
      FactoryBot.create(:contact_alias, destroyed_contact_id: 21, contact_id: @contact1.id)
    end
    ...
    it "should handle multiple merges" do
      FactoryBot.create(:contact_alias, destroyed_contact_id: 22, contact_id: @contact1.id)
      ids = ['21', '22']
      id1 = @contact1.id.to_s
